...
async def search_papers(
    ...
    """Search Semantic Scholar with free-text query, returning multiple results.

    Semantic Scholar uses ML-based relevance ranking that captures
